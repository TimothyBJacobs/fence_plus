...
class CPT {
	 ...
	 *
	 * @see WordPress Codex http://codex.WordPress.org/Function_Reference/register_post_type
	 */
	 ...
	 *
	 * @param string|array $taxonomy_names the slug for the taxonomy
	 * @param array $options taxonomy options
	 *
	 * @see WordPress codex http://codex.WordPress.org/Function_Reference/register_taxonomy
	 */
	 ...
	 *
	 * @param $column_name string the name of the column to populate
	 * @param $function,  an anonymous function to run when populating the column
	 */
